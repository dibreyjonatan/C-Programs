...
gnuplot -persist <<-EOF
    ...
    plot \
        "data_m4.txt"  using 1:2 with linespoints ls 1 title "m = 4", \
        "data_m8.txt"  using 1:2 with linespoints ls 2 title "m = 8", \
        "data_m12.txt" using 1:2 with linespoints ls 3 title "m = 12", \
        "data_m20.txt" using 1:2 with linespoints ls 4 title "m = 20",\
